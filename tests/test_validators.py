...
class TestSummaryValidator:
    ...
    def test_invalid_won_lost_sum(self, invalid_summary_df):
        ...
        assert any('won' in str(e).lower() or 'lost' in str(e).lower() 
    ...
    def test_invalid_points_calculation(self, invalid_summary_df):
        ...
        assert any('won' in str(e).lower() or 'lost' in str(e).lower() or 'consistency' in str(e).lower()
                  for e in result.errors)
...
class TestRankingValidator:
    ...
    def test_invalid_score_distribution(self, invalid_ranking_df):
        ...
        assert any('distribution' in str(w).lower() or 'score' in str(w).lower()
                  for w in result.warnings)
...
class TestPlayersValidator:
    ...
    def test_duplicate_hks_numbers(self, invalid_players_df):
        ...
        assert any('hks' in str(e).lower() and 'duplicate' in str(e).lower() 
                  for e in result.errors)
...
class TestValidateAllDivisionData:
    ...
    def test_validate_all_with_valid_data(self, valid_teams_df, valid_summary_df, 
                                          valid_schedules_df, valid_ranking_df, 
                                          valid_players_df):
...
class TestValidatorIntegration:
    ...
    def test_full_division_validation_pipeline(self, valid_teams_df, valid_summary_df,
                                               valid_schedules_df, valid_ranking_df,
                                               valid_players_df):
